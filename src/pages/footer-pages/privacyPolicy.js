    ...
    <div className="w-full bg-white min-h-screen">
      <div className="max-w-5xl mx-auto p-0 container">
        <div className="privacy-cont">
          <h1 className="heading-big-medium text-center">Privacy Policy</h1>
        ...
        <div className="px-3">
          ...
          <div className="mb-3">
            <p className="paragraph-big-regular text-content-secondary">
              At Skillang ("we", "our", or "us"), we respect your privacy and
          ...
          <div className="border-b border-gray-200 pb-6 mb-2">
            ...
            <div className="mb-4">
              ...
              <p className="paragraph-small-regular text-content-secondary mb-4">
                ...
                number, location, education history, professional experience,
                and other details relevant to your inquiries about work abroad,
                study abroad, nursing programs, or language test preparation.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="paragraph-small-regular text-content-secondary mb-4">
                ...
                information, location information, and site usage data. We
                collect this information using cookies and similar tracking
                technologies.
              </p>
            </div>
          </div>
          ...
          <div className="border-b border-gray-200 pb-6 mb-2">
            ...
            <div className="mb-4">
              ...
              <p className="paragraph-small-regular text-content-secondary mb-4">
                ...
                tasks on our behalf and are obligated to maintain its
                confidentiality.
              </p>
              <p className="paragraph-small-regular text-content-secondary mb-2">
              ...
              <ul className="list-disc  mb-4 paragraph-small-regular text-content-secondary">
                ...
                <li>
                  Educational institutions and partners (with your consent)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="paragraph-small-regular text-content-secondary mb-4">
                ...
                court or government agency). We may also disclose your
                information to protect our rights, privacy, safety, or property,
                and that of our users or others.
              </p>
            </div>
          </div>
          ...
          <div className="border-b border-gray-200 pb-6 mb-2">
            ...
            <div>
              ...
              <p className="paragraph-small-regular text-content-secondary mb-4">
                ...
                Please note that certain features of our website may not
          ...
          <div className="border-b border-gray-200 pb-6 mb-2">
            ...
            <p className="paragraph-small-regular text-content-secondary mb-4">
              ...
              discover that a child has provided us with personal information,
