      ...
      <div className="w-full bg-white min-h-screen">
        <div className="max-w-5xl mx-auto p-0 container">
          <div className="privacy-cont ">
            <h1 className="heading-big-medium text-center">Terms of Use</h1>
          </div>
          <div className="px-3">
            ...
            <div className="mb-4">
              <p className="paragraph-big-regular text-content-secondary mb-4">
                ...
                services. By accessing or using Skillang.com, you agree to
            ...
            <div className="border-b border-gray-200 pb-6 mb-4">
              ...
              <ul className="list-disc pl-6 mb-2 paragraph-small-regular text-content-secondary">
                <li>
                  You must be at least 13 years old to use Skillang.com. If
                  under 18, you need parental/guardian consent.
                </li>
                <li>
                ...
                <li>
                  You may not misuse our services, including hacking,
                  distributing malware, or engaging in fraudulent activities.
                </li>
              </ul>
            </div>
            ...
            <div className="border-b border-gray-200 pb-6 mb-4">
              ...
              <ul className="list-disc pl-6 mb-2 paragraph-small-regular text-content-secondary">
                ...
                <li>
                  You agree not to post offensive, illegal, or infringing
                  content.
                </li>
              </ul>
            </div>
            ...
            <div className="border-b border-gray-200 pb-6 mb-4">
              ...
              <ul className="list-disc pl-6 mb-2 paragraph-small-regular text-content-secondary">
                ...
                <li>
                  Skillang.com is not responsible for any loss or damage
                  resulting from reliance on platform content.
                </li>
              </ul>
            </div>
